...
async def run(playwright):
    ...
    for query in queries:
        try:
            ...
            search_url = f'https://www.marketwatch.com/search?q={query.replace(" ", "%20")}&ts=0&tab=All%20News'
            ...
            for i in range(num_results):
                ...
                description_element = await article.query_selector('p.article__summary')
                ...
                if link != "No disponible":
                    ...
                    try:
                        ...
                        await article_page.wait_for_selector('section.ef4qpkp0', timeout=10000)

                        # Extraer todo el contenido dentro de `div.article__body`
    ...
    df.to_csv(f'marketwatch_{video_id}.csv', index=False)
    print(f'Datos guardados en marketwatch_search_results.csv')
